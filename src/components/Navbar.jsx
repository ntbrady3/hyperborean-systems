  ...
  return (
    <>
      ...
      <nav className={cn(
        ...
        <div className="container max-w-[85%] mt-4 rounded-md flex items-center justify-center overflow-visible">
          <div className="flex items-center justify-center w-full">
            {/* All Nav Items in a Flex Container */}
            <div className="flex items-center justify-center w-full gap-8 md:gap-10 lg:gap-12 max-w-4xl">
              {navItems.map((item, key) => (
                <a
                  key={key}
                  href={item.href}
                  className={cn(
                    "font-electrolize neon-glow text-xl md:text-xl lg:text-2xl transition-colors duration-300 text-center min-w-20 md:min-w-20 lg:min-w-28",
      ...
      <div className={cn(
        ...
        <button
          onClick={toggleMenu}
          className={cn(
            'cursor-pointer fixed bottom-4 right-4 z-[60] p-2 rounded-full bg-card',
